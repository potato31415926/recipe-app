...
public class PicturesService extends Service {
    ...
    private static final String TAG = "PicturesService";
    Api api;
        ...
        api.getPictures()
                ...
                .subscribe(new Observer<Pictures>() {
                    ...
                    public void onNext(Pictures pictures) {
                        ...
                        broadcastIntent.setAction("com.yzl.broadcast.pictures");
                        broadcastIntent.putExtra("pictures", JSONObject.toJSONString(pictures));
                        // 发送Broadcast
